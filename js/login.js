var LoginController = (function () {
   ...
   function init() {
      ...
      if (storage.get("adding_server_flow")) {
         console.log(
            "[LOGIN] Setting up popstate listener to detect navigation"
         );
      ...
      if (pendingServer && pendingServer.url) {
         ...
         setTimeout(function () {
            console.log(
               "[LOGIN] setTimeout callback executing, fetching system info for:",
               pendingServer.url
            );
            JellyfinAPI.getPublicSystemInfo(
               pendingServer.url,
               function (err, systemInfo) {
                  console.log(
                     "[LOGIN] getPublicSystemInfo callback - err:",
                     err,
                     "systemInfo:",
                     systemInfo
                  );
                  ...
                  console.log(
                     "[LOGIN] About to call loadPublicUsers for:",
   ...
   function cacheElements() {
      elements = {
         ...
         cancelQuickConnectBtn: document.getElementById(
            "cancelQuickConnectBtn"
         ),
         ...
         useManualQuickConnectBtn: document.getElementById(
            "useManualQuickConnectBtn"
         ),
         ...
         manualQuickConnectForm: document.getElementById(
            "manualQuickConnectForm"
         ),
         manualQuickConnectCode: document.getElementById(
            "manualQuickConnectCode"
         ),
         manualQuickConnectStatus: document.getElementById(
            "manualQuickConnectStatus"
         ),
         cancelManualQuickConnectBtn: document.getElementById(
            "cancelManualQuickConnectBtn"
         ),

         errorMessage: document.getElementById("errorMessage"),
         statusMessage: document.getElementById("statusMessage"),
         manualServerSection: document.getElementById("manualServerSection"),
         discoveredServersSection: document.getElementById(
   ...
   function setupEventListeners() {
      ...
      if (elements.backToServerListBtn) {
         elements.backToServerListBtn.addEventListener(
            "click",
      ...
      if (elements.showManualLoginBtn) {
         elements.showManualLoginBtn.addEventListener(
            "click",
            showManualLoginForm
         );
      ...
      if (elements.useManualPasswordBtn) {
         elements.useManualPasswordBtn.addEventListener(
            "click",
         ...
         elements.useManualPasswordBtn.addEventListener(
            ...
            function (e) {
               if (e.keyCode === KeyCodes.ENTER) {
                  ...
                  e.stopPropagation();
                  if (
                     elements.manualUsername &&
                     elements.manualUsername.offsetParent !== null
                  ) {
                  ...
                  e.stopPropagation();
                  if (
                     elements.useManualQuickConnectBtn &&
      ...
      if (elements.useManualQuickConnectBtn) {
         elements.useManualQuickConnectBtn.addEventListener(
            "click",
      ...
      if (elements.cancelManualLoginBtn) {
         elements.cancelManualLoginBtn.addEventListener(
            "click",
            cancelManualLogin
         );
         elements.cancelManualLoginBtn.addEventListener(
      ...
      if (elements.cancelManualQuickConnectBtn) {
         elements.cancelManualQuickConnectBtn.addEventListener(
            "click",
            cancelManualLogin
         );
         elements.cancelManualQuickConnectBtn.addEventListener(
      ...
      if (elements.useQuickConnectBtn) {
         elements.useQuickConnectBtn.addEventListener(
            "click",
         ...
         elements.useQuickConnectBtn.addEventListener("keydown", function (e) {
            if (e.keyCode === KeyCodes.ENTER) {
               ...
               if (
                  ...
                  elements.passwordInput.offsetParent !== null
               ) {
         ...
         elements.usePasswordBtn.addEventListener("keydown", function (e) {
            if (e.keyCode === KeyCodes.ENTER) {
               ...
               if (
                  ...
                  elements.cancelQuickConnectBtn &&
                  elements.cancelQuickConnectBtn.offsetParent !== null
               ) {
                  elements.cancelQuickConnectBtn.focus();
               }
            } else if (e.keyCode === KeyCodes.LEFT) {
               e.preventDefault();
               e.stopPropagation();
               if (
                  elements.useQuickConnectBtn &&
      ...
      if (elements.cancelQuickConnectBtn) {
         elements.cancelQuickConnectBtn.addEventListener(
            "click",
            backToUserSelection
         );
         elements.cancelQuickConnectBtn.addEventListener(
      ...
      if (elements.manualLoginSubmitBtn) {
         elements.manualLoginSubmitBtn.addEventListener(
            "click",
            handleManualLogin
         );
         elements.manualLoginSubmitBtn.addEventListener(
      ...
      if (elements.manualUsername) {
         elements.manualUsername.addEventListener("keydown", function (e) {
            if (e.keyCode === KeyCodes.ENTER) {
               ...
               e.stopPropagation();
               if (
                  elements.manualPassword &&
                  elements.manualPassword.offsetParent !== null
               ) {
                  elements.manualPassword.focus();
               }
            } else if (e.keyCode === KeyCodes.UP) {
      ...
      if (elements.manualPassword) {
         elements.manualPassword.addEventListener("keydown", function (e) {
            if (e.keyCode === KeyCodes.ENTER) {
               ...
               e.stopPropagation();
               if (
                  elements.manualLoginBtn &&
                  elements.manualLoginBtn.offsetParent !== null
               ) {
      ...
      if (elements.deleteServerBtn) {
         elements.deleteServerBtn.addEventListener(
            "click",
      ...
      if (elements.backToServerBtn) {
         elements.backToServerBtn.addEventListener(
            "click",
            backToServerSelection
         );
   ...
   function checkStoredAuth() {
      ...
      if (isAddingServer) {
         console.log(
            "[LOGIN] Skipping auto-redirect - in adding_server_flow mode"
         );
         return false;
      }
   ...
   function attemptAutoLogin(lastLogin) {
      showStatus(
         "Auto-login: connecting to " +
            (lastLogin.serverName || "server") +
            "...",
         "info"
      );
         ...
         function (err, systemInfo) {
            ...
            JellyfinAPI.getPublicUsers(
               ...
               function (err, users) {
                  ...
                  showStatus(
                     "Auto-login: logging in as " + user.Name + "...",
                     "info"
                  );
                  ...
                  JellyfinAPI.authenticateByName(
                     ...
                     function (err, authData) {
                        if (err || !authData || !authData.AccessToken) {
                           ...
                           showError(
                              "Auto-login failed: password required. Please login manually."
                           );
                           clearAutoLoginData();
                           setTimeout(function () {
      ...
      if (elements.addNewServerBtn) {
         var buttonHandler = function (e) {
            if (e.keyCode === KeyCodes.ENTER) {
               ...
               e.preventDefault();
               var cards =
                  elements.savedServerRow.querySelectorAll(".user-card");
               if (cards.length > 0) {
      ...
      JellyfinAPI.discoverServers(function (err, servers) {
         ...
         if (err) {
            ...
            if (currentServers.length > 0) {
               showStatus(
                  "Found " + currentServers.length + " server(s)!",
                  "success"
               );
            } else {
               clearStatus();
   ...
   function renderServerList(servers) {
      ...
      if (servers.length === 0) {
         elements.serverList.innerHTML =
            '<li class="server-item empty">No servers discovered</li>';
   ...
   function handleConnect() {
      ...
      if (!serverUrl) {
         showError(
            "Please enter a server address or select a discovered server"
         );
         return;
      }
      ...
      function tryMultiplePorts(urls, index) {
         ...
         if (index >= urls.length) {
            ...
            showError(
               "Unable to connect to server. Tried " +
                  urls.length +
                  " configurations. Check the address or specify a port (e.g., http://192.168.1.1:8096)"
            );
            return;
         }
         ...
         JellyfinAPI.testServer(currentUrl, function (err, serverInfo) {
            console.log(
               "[tryMultiplePorts] Callback received - err:",
               err,
               "serverInfo:",
               serverInfo
            );
            if (err) {
               ...
               // Success!
               console.log(
                  "[tryMultiplePorts] SUCCESS! Server found:",
                  serverInfo.name
               );
               if (elements.connectBtn) {
                  elements.connectBtn.disabled = false;
               ...
               showStatus(
                  "Connected to " + serverInfo.name + "! Loading users...",
                  "success"
               );
      ...
      function tryConnect(url) {
         JellyfinAPI.testServer(url, function (err, serverInfo) {
            ...
            if (err) {
               showError(
                  "Unable to connect to server. Check the address and try again."
               );
            } else {
               showStatus(
                  "Connected to " + serverInfo.name + "! Loading users...",
   ...
   function loadPublicUsers(serverAddress) {
      console.log(
         "[LOGIN] loadPublicUsers called with serverAddress:",
         serverAddress
      );
      JellyfinAPI.getPublicUsers(serverAddress, function (err, users) {
         console.log(
            "[LOGIN] getPublicUsers callback - err:",
            err,
            "users count:",
         ...
         if (!users || users.length === 0) {
            ...
            showStatus(
               'No public users found. Use "Add Account" to login manually.',
               "info"
            );
         ...
         console.log(
            "[LOGIN] About to hide server selection and show user selection"
         );
         ...
         console.log(
            "[LOGIN] Calling renderUserRow with",
            publicUsers.length,
            "users"
         );
         ...
         console.log(
            "[LOGIN] loadPublic Users complete - about to clear status"
         );
         clearStatus();
         console.log(
            "[LOGIN] clearStatus done - loadPublicUsers callback completed"
         );

         // Add a listener to catch any unexpected navigation
         if (storage.get("adding_server_flow")) {
            console.log(
               "[LOGIN] Adding navigation listener to catch unexpected redirects"
            );
   ...
   function renderUserRow(users) {
      ...
      users.forEach(function (user, index) {
         ...
         if (user.PrimaryImageTag) {
            var imgUrl = JellyfinAPI.getUserImageUrl(
               connectedServer.address,
               user.Id,
         ...
         userCard.addEventListener("keydown", function (e) {
            if (e.keyCode === KeyCodes.ENTER) {
               ...
               if (elements.showManualLoginBtn) {
                  elements.showManualLoginBtn.focus();
               } else if (elements.deleteServerBtn) {
      ...
      if (elements.showManualLoginBtn) {
         ...
         elements.showManualLoginBtn.removeEventListener(
            "keydown",
            manualLoginHandler
         );
         elements.showManualLoginBtn.addEventListener(
      ...
      if (elements.deleteServerBtn) {
         ...
         elements.deleteServerBtn.removeEventListener(
            "keydown",
            deleteServerHandler
         );
         elements.deleteServerBtn.addEventListener(
      ...
      if (elements.backToServerBtn) {
         ...
         elements.backToServerBtn.removeEventListener(
            "keydown",
            backToServerHandler
         );
         elements.backToServerBtn.addEventListener(
   ...
   function selectUser(index) {
      ...
      if (selectedUser.isSaved && connectedServer) {
         ...
         var savedUser = savedUsers.find(function (u) {
            return u.userId === selectedUser.Id;
         });
         ...
         if (savedUser && savedUser.accessToken) {
            ...
            JellyfinAPI.getUserInfo(
               ...
               function (err, userInfo) {
                  if (err) {
                     console.log(
                        "[LOGIN] Saved credentials failed, showing login form:",
                        err
                     );
                     showError(
                        "Saved credentials expired. Please sign in again."
                     );
                     showLoginOptions();
                  } else {
                     console.log(
                        "[LOGIN] Auto-login successful for:",
                        userInfo.Name
                     );
                     clearStatus();
                     window.location.href = "browse.html";
   ...
   function initiateQuickConnectFlow(config) {
      ...
      JellyfinAPI.initiateQuickConnect(
         connectedServer.address,
         function (err, data) {
   ...
   function pollQuickConnectStatus(config) {
      ...
      JellyfinAPI.checkQuickConnectStatus(
         connectedServer.address,
         quickConnectSecret,
         function (err, statusData) {
            ...
            JellyfinAPI.authenticateQuickConnect(
               connectedServer.address,
               quickConnectSecret,
               function (authErr, authData) {
                  ...
                  if (isAddingServer) {
                     ...
                     if (typeof MultiServerManager !== "undefined") {
                        ...
                        var serverName =
                           connectedServer.name || "Jellyfin Server";
                  ...
                  showStatus(
                     "Login successful! Welcome, " + authData.User.Name + "!",
                     "success"
                  );
   ...
   function handleManualLogin() {
      ...
      var username = elements.manualUsername
         ? elements.manualUsername.value.trim()
         : "";
      var password = elements.manualPassword
         ? elements.manualPassword.value
         : "";
      ...
      JellyfinAPI.authenticateByName(
         ...
         function (err, authData) {
            ...
            showStatus(
               "Login successful! Welcome, " + authData.username + "!",
               "success"
            );
   ...
   function showPasswordForm() {
      ...
      updateSelectedUserInfo(
         elements.selectedUserAvatar,
         elements.selectedUserName
      );
   ...
   function showQuickConnectForm() {
      ...
      // Update user info
      updateSelectedUserInfo(
         elements.qcSelectedUserAvatar,
         elements.qcSelectedUserName
      );

      // Focus the cancel button so user can navigate
      setTimeout(function () {
         if (elements.cancelQuickConnectBtn) {
            elements.cancelQuickConnectBtn.focus();
         }
   ...
   function deleteConnectedServer() {
      ...
      showConfirmation(
         ...
         'Are you sure you want to delete "' +
            connectedServer.name +
            '" from this device? You can re-add it later.',
         function (confirmed) {
            if (confirmed) {
               // Remove from MultiServerManager
               if (typeof MultiServerManager !== "undefined") {
                  // Get all users for this server
                  var usersForServer = MultiServerManager.getServerUsers(
                     connectedServer.id
                  );
      ...
      JellyfinAPI.authenticateByName(
         ...
         function (err, authData) {
            ...
            if (isAddingServer) {
               ...
               var existingServers = MultiServerManager
               ...
               var serverExists = existingServers.some(function (s) {
                  ...
                  return (
                     normalizeUrl(s.url) ===
                     normalizeUrl(connectedServer.address)
                  );
               });
               ...
               if (serverExists) {
                  console.log(
                     "[LOGIN] Clearing adding_server_flow - logging into existing server"
                  );
                  storage.remove("adding_server_flow");
               } else {
                  console.log(
                     "[LOGIN] Keeping adding_server_flow - this is a new server"
                  );
               }
            }
   ...
   function initiateQuickConnect() {
      ...
      if (elements.quickConnectStatus) {
         elements.quickConnectStatus.textContent =
            "Initiating Quick Connect...";
   ...
   function handleManualLogin() {
      ...
      if (isAddingServer && !username) {
         console.log(
            "[LOGIN] handleManualLogin called but skipping - in adding_server_flow mode with no username entered"
         );
         return;
      }
      ...
      JellyfinAPI.authenticateByName(
         ...
         function (err, authData) {
            ...
            console.log(
               "[LOGIN] After successful login, adding_server_flow:",
               isAddingServer
            );
            ...
            setTimeout(function () {
               if (isAddingServer) {
                  console.log(
                     "[LOGIN] In adding_server_flow, redirecting to settings.html"
                  );
                  storage.remove("adding_server_flow");
                  storage.remove("pending_server");
                  window.location.href = "settings.html";
                  ...
                  console.log(
                     "[LOGIN] Normal login, redirecting to browse.html"
                  );
                  window.location.href = "browse.html";
               }
            }, LOGIN_SUCCESS_DELAY_MS);
